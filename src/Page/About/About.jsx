...
// Dummy Data
import { dummyCompanyInfo2, dummyCompanyHistory } from "../../DummyData/dummyData.js";

// Images
import companyImg from '../../assets/images/Image2.jpg';

const About = () => {
  return (
    <div className='container mx-auto px-4 py-32 max-w-7xl'>
      <div className='relative rounded-2xl overflow-hidden shadow-2xl mb-24'>
        <img src={companyImg} className='w-full h-full object-cover' alt='companyImg.jpg' />
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-10 mb-24'>
        { dummyCompanyInfo2.map((value, index) => (
          <div key={index} className='bg-white p-10 rounded-xl shadow-lg text-center hover:shadow-2xl transition-all duration-300 border border-gray-100'>
      ...
      <div className='mb-24 max-w-4xl mx-auto text-center'>
        <h2 className="text-4xl font-bold mb-8 text-slate-800 text-center">회사 비전</h2>
        <p className='text-2xl leading-relaxed text-gray-600 font-light'>
          "2030년까지 글로벌 시장을 선도하는 기술 혁신 기업으로 도약하여, <br />더 나은 세상을 만드는데 기여하겠습니다."
        </p>
      </div>
      ...
      <div className='mb-24'>
        ...
        <div className='space-y-12 max-w-5xl mx-auto'>
          { dummyCompanyHistory.map((item, index) => (
