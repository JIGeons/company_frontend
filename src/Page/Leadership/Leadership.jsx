  ...
  return (
    <div className='container max-w-7xl mx-auto px-4 py-32'>
      <div className='text-center mb-12'>
        ...
        <p className='text-lg text-gray-600'>혁신과 성장을 이끄는 ABC Company의 리더쉽</p>
      </div>
      ...
      <div className='flex flex-col md:flex-row gap-12 mb-24 items-center'>
        <div className='md:w-2/3'>
          ...
          <div className='text-lg text-gray-600 space-y-6'>
            ...
            <p className='font-semibold mt-8'>ABC Company 대표이사 김대표 드림</p>
          </div>
        </div>
        <div className='md:w-1/3'>
          <div className='rounded-xl overflow-hidden shadow-lg'>
            <img src={Human} className='w-full aspect-[3/4] object-cover' alt='ceo.jpg' />
      ...
      <div className='mb-24'>
        <h2 className='text-3xl text-gray-800 mb-12 text-center'>경영진</h2>
      ...
      <div className='mb-24'>
        <h2 className='text-3xl text-gray-800 mb-12 text-center'>핵심 구성원</h2>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
