            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                ...
                <div className='flex-1 w-full max-w-2xl lg:max-w-none'>
                    <div className='relative'>
                        <img src={HeroImage} className='relative rounded-2xl shadow-2xl w-full object-cover transform hover:scale-[1.02] transition-transform duration-300'  alt={'heroImg.jpg'}/>
                    </div>
                </div>
            </div>
        </div>
